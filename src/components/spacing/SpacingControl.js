...
const SPACING_TYPE_OPTIONS = [
	{ label: __('Padding', 'naviddev-gutenberg-blocks'), value: 'padding' },
	{ label: __('Margin', 'naviddev-gutenberg-blocks'), value: 'margin' },
];
		...
		<>
			<div className="mb-3">
				<div className="component-sidebar-title">
					<label>{__('Spacing Type', 'naviddev-gutenberg-blocks')}</label>
				</div>
				<ButtonGroup>
